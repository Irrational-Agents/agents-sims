...
class UnityServer:
    def __init__(self):
        ...
        self.command_map = {
            'ui.tick': self.update,
            'map.getTownData.response': self.handlers.handle_map_data,
            'map.getSceneMetadata.response': self.handlers.handle_meta_data,
            'config.getBlockData.response': self.handlers.handle_block_data
        }
